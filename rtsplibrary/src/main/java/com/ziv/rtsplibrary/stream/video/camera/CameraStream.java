...
import com.ziv.rtsplibrary.exceptions.CameraInUseException;
import com.ziv.rtsplibrary.exceptions.ConfNotSupportedException;
import com.ziv.rtsplibrary.exceptions.InvalidSurfaceException;
import com.ziv.rtsplibrary.gl.SurfaceView;
import com.ziv.rtsplibrary.hw.EncoderDebugger;
import com.ziv.rtsplibrary.hw.NV21Convertor;
import com.ziv.rtsplibrary.rtsp.rtp.MediaCodecInputStream;
 ...
 */
public abstract class CameraStream extends MediaStream {
    ...
    public CameraStream(int camera) {
        super();
        setCamera(camera);
    }
